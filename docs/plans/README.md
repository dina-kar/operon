...
| [M1.3: Hot tier, maintenance and affinity routing](2026-09-24-m1.3-hot-tier-routing.md) | Split merges, Lance compaction, qdrant-edge HNSW artifacts, pinned splits, the metastore over the network, node registry, rendezvous routing, the hot on/off differential harness; the unapplied-data budget and write backpressure (Task 15, added 2026-09-26, D86) | M1.2 | **In progress**: Tasks 0–2 merged; Tasks 3–5 in PRs #33 and #34, Task 6 in PR #35 |
