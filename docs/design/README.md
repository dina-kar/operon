...
| 02 | [Stream engine](02-stream-engine.md) | The internal log and its APIs: WAL durability classes, write/read/failover protocols, the native streaming API and Flight ingest, OTLP logs ingest, the Kafka gateway, ecosystem integrations, changelog streams | **Approved** |
