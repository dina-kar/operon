...
// Vendored from quickwit-oss/quickwit af0591a3 (quickwit/quickwit-query/src/elastic_query_dsl/match_phrase_query.rs); modified for Operon: imports rewritten to crate paths.
...
use crate::query::query_ast::{FullTextMode, FullTextParams, FullTextQuery, QueryAst};
use crate::query::{MatchAllOrNone, OneFieldMap};
