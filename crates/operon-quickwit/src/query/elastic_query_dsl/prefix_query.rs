...
// Vendored from quickwit-oss/quickwit af0591a3 (quickwit/quickwit-query/src/elastic_query_dsl/prefix_query.rs); modified for Operon: imports rewritten to crate paths.
